...
answer:represent one person who had get nobel
obs:935
varibles:26
...
```
answer:yes,because in buzzfeed we analyzing the data to search for more understanding the data and get information form it we go deep and deep and make a lot of filtrations to understanding the data.
